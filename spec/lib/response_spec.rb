...
describe Weather::Response, :vcr do
  ...
  let(:invalid_response) { WeatherAPI.lookup 8888888888 }
  ...
  it 'should contain the WOEID of the request location and the requested URL' do
    ...
    expect(response.request_url).to eq "http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weatherAPI.forecast%20where%20woeid%3D9848%20and%20u%3D'c'&format=json"
  end
